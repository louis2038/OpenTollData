...
if __name__ == "__main__":
    ...
    assert_matrix_shape(matrix_class1, "classe 1", 36, 30)
    assert_matrix_shape(matrix_class2, "classe 2", 36, 30)
    assert_matrix_shape(matrix_class3, "classe 3", 36, 30)
    assert_matrix_shape(matrix_class4, "classe 4", 36, 30)
    assert_matrix_shape(matrix_class5, "classe 5", 36, 30)

    stations_rows = read_station_names(names_filepath_rows)
    stations_columns = read_station_names(names_filepath_columns)

    desactivate_index_rows = [12, 22, 23, 26, 28, 29, 30, 31, 32, 33, 34, 35]
    desactivate_index_columns = [0, 1, 2, 3, 4, 5, 6, 7, 8]
